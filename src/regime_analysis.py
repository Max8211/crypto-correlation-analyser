...
def main():
    ...
    # Detect regimes
    regimes = detect_regimes_by_drawdown(drawdown, crash_thresh=-0.25, stress_thresh=-0.10)

    # Save detected regimes list
    regimes_df = []
    ...
    # Normal window: search for period with low drawdown
    ...
    # Compute regime correlations and vol
